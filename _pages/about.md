...
I’m an applied deep learning scientist, mainly focusing on designing perception algorithms for autonomous driving systems. I have worked in industry for 5+ years. I obtained my M.S (major in autonomous driving) from at [RWTH Aachen University](https://www.rwth-aachen.de/cms/~a/root/?lidx=1) in 2019. I got my B.S from [Beijing Institute of Technology](https://english.bit.edu.cn/). My research areas mainly include 3d object detection, segmentation, depth estimation, stereo matching, etc.
